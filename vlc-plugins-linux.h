...
int vlc_entry__codec_schroedinger (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__access_pulsesrc (int (*)(void *, void *, int, ...), void *);
int vlc_entry__audio_output_pulse (int (*)(void *, void *, int, ...), void *);
int vlc_entry__services_discovery_pulselist (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__codec_mad (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__codec_mpeg2 (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__misc_addons_vorepository (int (*)(void *, void *, int, ...), void *);
int vlc_entry__misc_addons_fsstorage (int (*)(void *, void *, int, ...), void *);
...
const void *vlc_static_modules[] = {
 ...
 (void *)   vlc_entry__misc_addons_fsstorage,
